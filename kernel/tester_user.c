...
static ebpf_specify_name_t dc_optional_name[] = { {.program_name = "khulnasoft_lookup_fast",
...
ebpf_module_t ebpf_modules[] = {
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_10 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_BTRFS, .name = "btrfs", .update_names = NULL, .ctrl_table = "btrfs_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_15 | KHULNASOFT_V5_14 | KHULNASOFT_V5_16,
      .flags = KHULNASOFT_FLAG_CACHESTAT, .name = "cachestat", .update_names = NULL, .ctrl_table = "cstat_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_DC, .name = "dc", .update_names = dc_optional_name, .ctrl_table = "dcstat_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_DISK, .name = "disk", .update_names = NULL, .ctrl_table = "disk_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_EXT4, .name = "ext4", .update_names = NULL, .ctrl_table = "ext4_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_11 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_FD, .name = "fd", .update_names = NULL, .ctrl_table = "fd_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SYNC, .name = "fdatasync", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SYNC, .name = "fsync", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_HARDIRQ, .name = "hardirq", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_MDFLUSH, .name = "mdflush", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_MOUNT, .name = "mount", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SYNC, .name = "msync", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SOCKET, .name = "socket", .update_names = NULL, .ctrl_table = "socket_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_NFS, .name = "nfs", .update_names = NULL, .ctrl_table = "nfs_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_NETWORK_VIEWER, .name = "network_viewer", .update_names = NULL, .ctrl_table = "nv_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_OOMKILL, .name = "oomkill", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14 | KHULNASOFT_V5_10,
      .flags = KHULNASOFT_FLAG_PROCESS, .name = "process", .update_names = NULL, .ctrl_table = "process_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SHM, .name = "shm", .update_names = NULL, .ctrl_table = "shm_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SOFTIRQ, .name = "softirq", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SYNC, .name = "sync", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SYNC, .name = "syncfs", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_SYNC, .name = "sync_file_range", .update_names = NULL, .ctrl_table = NULL },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14 | KHULNASOFT_V6_8,
      .flags = KHULNASOFT_FLAG_SWAP, .name = "swap", .update_names = NULL, .ctrl_table = "swap_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_VFS, .name = "vfs", .update_names = NULL, .ctrl_table = "vfs_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_XFS, .name = "xfs", .update_names = NULL, .ctrl_table = "xfs_ctrl" },
    { .kernels =  KHULNASOFT_V3_10 | KHULNASOFT_V4_14 | KHULNASOFT_V4_16 | KHULNASOFT_V4_18 | KHULNASOFT_V5_4 | KHULNASOFT_V5_14,
      .flags = KHULNASOFT_FLAG_ZFS, .name = "zfs", .update_names = NULL, .ctrl_table = "zfs_ctrl" },

    { .kernels = 0, .name = NULL, .update_names = NULL }
};

char *specific_ebpf = NULL;
char *khulnasoft_path = NULL;
char *log_path = NULL;
#define KHULNASOFT_DEFAULT_PROCESS_NUMBER 4096
long nprocesses;
FILE *stdlog = NULL;
int end_iteration = 1;
 ...
 *
 * Khulnasoft delivers for users eBPF programs with specific suffixes that represent the kernels they were
...
static int ebpf_select_max_index(int rhf_version, uint32_t kver)
{
    if (rhf_version > 0) { // Red Hat family
        if (kver >= KHULNASOFT_EBPF_KERNEL_5_14)
            return 7;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_5_4) 
            return 4;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_4_11)
            return 3;
    } else { // Kernels from kernel.org
        if (kver >= KHULNASOFT_EBPF_KERNEL_6_8)
            return 10;
	else if (kver >= KHULNASOFT_EBPF_KERNEL_5_16)
            return 9;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_5_15)
            return 8;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_5_11)
            return 6;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_5_10)
            return 5;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_4_17)
            return 4;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_4_15)
            return 2;
        else if (kver >= KHULNASOFT_EBPF_KERNEL_4_11)
            return 1;
    }
...
/*
 * Start Khulnasoft JSON
 *
 * Writes the first lines for JSON message when software is testing all eBPF programs delivered by Khulnasoft.
 *
 * @param filename  the file to be tested.
 * @param is_return the file type.
 */
static void ebpf_start_khulnasoft_json(char *filename, int is_return)
{
    static int first = 1;
    if (first) {
        first = 0;
 ...
 *
 *  Khulnasoft eBPF programs has the following format:
 * 
 *      Tkhulnasoft_ebpf_N.V.o
 *  
 *  where:
...
static void ebpf_mount_name(char *out, size_t len, uint32_t kver, char *name, int is_return, int rhf_version)
{
    ...
    char *path = (!khulnasoft_path) ? getcwd(NULL, 0) : realpath(khulnasoft_path, NULL);
    snprintf(out, len, "%s/%ckhulnasoft_ebpf_%s.%s%s.o", 
            path,
            (is_return) ? 'r' : 'p',
            name,
            version,
 ...
 *
 * This controller table is a table used by Khulnasoft to control the eBPF programs metrics. We use it to define
...
static void ebpf_controller_json(ebpf_table_data_t *values, int fd)
{
    ...
    for (key = 0; key < KHULNASOFT_CONTROLLER_END; key++) {
...
#endif
        uint32_t values[KHULNASOFT_CONTROLLER_END] = { 1, map_level, 0, 0, 0, 0};
        for (i = 0; i < end; i++) {
 ...
 * @param ctrl       Fill ctrl table to have apps data (only available for khulnasoft)
 *
...
/**
 *  Run khulnasoft tests
 *
 *  Run tests for each eBPF program delivered by Khulnasoft.
 *
 ...
 */
static void ebpf_run_khulnasoft_tests(int rhf_version, uint32_t kver, int is_return, uint64_t flags)
{
    ...
    while (ebpf_modules[i].name) {
        if (flags & ebpf_modules[i].flags) {
            ...
            ebpf_start_khulnasoft_json(load, is_return);
            char *result = ebpf_tester(load, ebpf_modules[i].update_names, flags & KHULNASOFT_FLAG_CONTENT, 
...
static void ebpf_help()
{
    fprintf(stdout, "Usage: ./legacy_test [OPTION]....\n"
                    ...
                    "--all              Test all khulnasoft eBPF programs.\n"
                    ...
                    "--khulnasoft-path     Directory where eBPF programs are present.\n"
                    ...
                    "You can also specify an unique eBPF program developed by Khulnasoft with the following\n"
                    "options:\n"
...
{
    return KHULNASOFT_FLAG_ALL &
                             ~(KHULNASOFT_FLAG_FS | KHULNASOFT_FLAG_LOAD_BINARY | KHULNASOFT_FLAG_MDFLUSH | KHULNASOFT_FLAG_CONTENT);
}
...
uint64_t ebpf_parse_arguments(int argc, char **argv, int kver)
{
    ...
    static struct option long_options[] = {
        ...
        {"khulnasoft-path",       required_argument,    0,  0 },
    ...
    while (1) {
        ...
        switch (option_index) {
            // SPECIFIC THREADS
            case KHULNASOFT_OPT_BTRFS:
                {
                    flags |= KHULNASOFT_FLAG_BTRFS;
                    break;
                }
            case KHULNASOFT_OPT_CACHESTAT:
                {
                    flags |= KHULNASOFT_FLAG_CACHESTAT;
                    break;
                }
            case KHULNASOFT_OPT_DC:
                {
                    flags |= KHULNASOFT_FLAG_DC;
                    break;
                }
            case KHULNASOFT_OPT_DISK:
                {
                    flags |= KHULNASOFT_FLAG_DISK;
                    break;
                }
            case KHULNASOFT_OPT_EXT4:
                {
                    flags |= KHULNASOFT_FLAG_EXT4;
                    break;
                }
            case KHULNASOFT_OPT_FD:
                {
                    flags |= KHULNASOFT_FLAG_FD;
                    break;
                }
            case KHULNASOFT_OPT_SYNC:
                {
                    flags |= KHULNASOFT_FLAG_SYNC;
                    break;
                }
            case KHULNASOFT_OPT_HARDIRQ:
                {
                    flags |= KHULNASOFT_FLAG_HARDIRQ;
                    break;
                }
            case KHULNASOFT_OPT_MDFLUSH:
                {
                    flags |= KHULNASOFT_FLAG_MDFLUSH;
                    break;
                }
            case KHULNASOFT_OPT_MOUNT:
                {
                    flags |= KHULNASOFT_FLAG_MOUNT;
                    break;
                }
            case KHULNASOFT_OPT_NETWORK_VIEWER:
                {
                    flags |= KHULNASOFT_FLAG_NETWORK_VIEWER;
                    break;
                }
            case KHULNASOFT_OPT_OOMKILL:
                {
                    flags |= KHULNASOFT_FLAG_OOMKILL;
                    break;
                }
            case KHULNASOFT_OPT_PROCESS:
                {
                    flags |= KHULNASOFT_FLAG_PROCESS;
                    break;
                }
            case KHULNASOFT_OPT_SHM:
                {
                    flags |= KHULNASOFT_FLAG_SHM;
                    break;
                }
            case KHULNASOFT_OPT_SOCKET:
                {
                    flags |= KHULNASOFT_FLAG_SOCKET;
                    break;
                }
            case KHULNASOFT_OPT_SOFTIRQ:
                {
                    flags |= KHULNASOFT_FLAG_SOFTIRQ;
                    break;
                }
            case KHULNASOFT_OPT_SWAP:
                {
                    flags |= KHULNASOFT_FLAG_SWAP;
                    break;
                }
            case KHULNASOFT_OPT_VFS:
                {
                    flags |= KHULNASOFT_FLAG_VFS;
                    break;
                }
            case KHULNASOFT_OPT_NFS:
                {
                    flags |= KHULNASOFT_FLAG_NFS;
                    break;
                }
            case KHULNASOFT_OPT_XFS:
                {
                    flags |= KHULNASOFT_FLAG_XFS;
                    break;
                }
            case KHULNASOFT_OPT_ZFS:
                {
                    flags |= KHULNASOFT_FLAG_ZFS;
                    break;
                }
            // COMMON OPTIONS    
            case KHULNASOFT_OPT_HELP:
                {
                    ebpf_help();
                    exit(0);
                }
            case KHULNASOFT_OPT_ALL:
                {
                    flags |= KHULNASOFT_FLAG_ALL;
                    break;
                }
            case KHULNASOFT_OPT_COMMON:
                {
                    flags |= ebpf_set_common_flag();
                    break;
                }
            case KHULNASOFT_OPT_LOAD_BINARY:
                {
                    specific_ebpf = optarg;
                    flags |= KHULNASOFT_FLAG_LOAD_BINARY;
                    break;
                }
            case KHULNASOFT_OPT_CONTENT:
                {
                    flags |= KHULNASOFT_FLAG_CONTENT;
                    break;
                }
            case KHULNASOFT_OPT_KHULNASOFT_PATH:
                {
                    khulnasoft_path = optarg;
                    break;
                }
            case KHULNASOFT_OPT_LOG_PATH:
                {
                    log_path = optarg;
            ...
            case KHULNASOFT_OPT_PID:
                {
                    int value = (int)strtol(optarg, NULL, 10);
                    if (value < KHULNASOFT_APPS_LEVEL_REAL_PARENT || value >= KHULNASOFT_APPS_LEVEL_END) {
    ...
    if (!(flags & (KHULNASOFT_FLAG_ALL & ~(KHULNASOFT_FLAG_CONTENT))))
        flags |= ebpf_set_common_flag();

    // The necessary tracepoint was made in kernel 4.14, so we cannot
    // test before this version
    if (kver < KHULNASOFT_EBPF_KERNEL_4_14)
        flags &= ~KHULNASOFT_FLAG_OOMKILL;
...
int main(int argc, char **argv)
{
    ...
    if (nprocesses < 0) {
        fprintf(stderr, "Cannot find number of proccess, using the default %lu\n", (unsigned long int)KHULNASOFT_DEFAULT_PROCESS_NUMBER);
        nprocesses = KHULNASOFT_DEFAULT_PROCESS_NUMBER;
    }
    ...
    if (!(flags & KHULNASOFT_FLAG_LOAD_BINARY)) {
        ebpf_fill_names();

        ebpf_run_khulnasoft_tests(rhf_version, my_kernel, 1, flags);
        ebpf_run_khulnasoft_tests(rhf_version, my_kernel, 0, flags);

        ebpf_clean_name_vectors();
    } else {
        if (specific_ebpf) {
            ebpf_start_external_json(specific_ebpf);
            char *result = ebpf_tester(specific_ebpf, NULL, flags & KHULNASOFT_FLAG_CONTENT, NULL, my_kernel);
            fprintf(stdlog, "    },\n    \"Status\" :  \"%s\"\n},\n", result);
        }
    }
